...
export class ChaosArea extends React.Component<any, iComfortState> {
    ...
    render() {
        return <g>
            <rect onMouseEnter={this._onMouseEnter} onMouseLeave={this._onMouseLeave} className="area js-area-standard" id="chaos" width="800" height="800" style="{this.state.style}"></rect>
...
export class StretchArea extends React.Component<any, iComfortState> {
    ...
    render() {
        return <g>
            <circle onMouseEnter={this._onMouseEnter} onMouseLeave={this._onMouseLeave} className="area js-area-standard" id="stretch" r="300.12599083141845" cx="400" cy="400"  style="{this.state.style}"></circle>
