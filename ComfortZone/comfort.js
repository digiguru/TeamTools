...
define(["require", "exports", 'Polar'], function (require, exports, Plot) {
    "use strict";
    var Comfort;
    (function (Comfort) {
        var Timed = (function () {
        ...
        var GraphComfortEntry = (function (_super) {
            ...
            GraphComfortEntry.prototype.graphMove = function () {
                ...
                return function (d, i) {
                    ...
                    var distance = Plot.Point.distance(that.centerPoint, Plot.Point.fromCoords(coord));
            ...
            GraphComfortEntry.prototype.graphUp = function () {
                ...
                return function (d, i) {
                    /* 'this' is the DOM element */
                    var coord = Plot.Point.fromCoords(d3.mouse(this));
                    var distance = Plot.Point.distance(that.centerPoint, coord);
                    var area = GraphComfortEntry.calculateDistance(distance);
